...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Bordado Calima</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Jhonatan Sanabria</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <?php if($_SESSION['S_ROL']=='Administrador') {?>
          ...
          <li class="nav-item">
            <a onclick="cargar_contenido('contenido_principal','cliente/view_cliente.php')" class="nav-link">
          ...
          <li class="nav-item">
            <a onclick="cargar_contenido('contenido_principal','producto/view_producto.php')" class="nav-link">
